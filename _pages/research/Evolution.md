...
In
[[Rum04c]](#Rum04c) and [[Rum12]](#Rum12) we describe an agile, 
...
invalidated in the refinement steps. In [[KPR97]](#KPR97) we applied 
this refinement
...
We refined and applied this to automated semantics-preserving parallel
decomposition of finite component and connector architectures in
[[KRW20]](#KRW20) and sketch the ideas for a 
synthesis technique from crosscutting and thus incomplete
structural views in [[MRR14a]](#MRR14a).

As performing a refinement step is error-prone, we present a language
independent and fully automated
method to **repair failed model refinements** [[KR18a]](#KR18a). 
This is possible by identifying
...
observable behavior and became prominent with agile development. 
In [[PR01]](#PR01) 
we traced back refactoring of programs to related techniques,
e.g., known from math or theorem provers. In [[PR03]](#PR03) we have 
discussed the
...
their application in software development. In [[Rum12]](#Rum12) we 
therefore discuss
...
related artifacts. In [[MRR11d]](#MRR11d) we discuss a technique to 
identify semantic
...
It is important to understand semantic differences between refactoring 
steps on data
...
We also applied **compatibility checking of evolved models** on 
Simulink, e.g., in
[[RSW+15]](#RSW+15), where we identified in which system context a 
component can be
...
[[HRRS11]](#HRRS11)
and extended this into a hierarchical approach in [[HRR+11]](#HRR+11). 
Second, we
discussed in [[HRRS12]](#HRRS12), how to evolve a complete product 
line architecture,
...
[[Wei12]](#Wei12) [[HRW15]](#HRW15) [[Hoe18]](#Hoe18) we present 
a technique that derives a
...
5. Using model transformations as individually applicable 
    "deltas" allows describing
6. model and therefore software variants.
7. Language specific transformation languages can be systematically
   derived from given descriptions of modeling languages.
